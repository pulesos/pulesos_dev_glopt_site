...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.reviews__slider__content', '.reviews__arrow_left', '.reviews__arrow_right');
...
var modal = function modal() {
  function bindModal(btnTrigger, modalTrigger, closeTrigger) {
    var btns = document.querySelectorAll(btnTrigger),
...
var slider = function slider(slideSelector, prevSelector, nextSelector) {
  var slideIndex = 1,
